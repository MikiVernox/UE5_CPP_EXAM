...
// Cross Module References
	CPP_API UClass* Z_Construct_UClass_ABlock();
	CPP_API UClass* Z_Construct_UClass_ABlock_NoRegister();
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABlock_Statics::NewProp_BlockMesh = { "BlockMesh", nullptr, (EPropertyFlags)0x00400000000a0009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ABlock, BlockMesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ABlock_Statics::NewProp_BlockMesh_MetaData), Z_Construct_UClass_ABlock_Statics::NewProp_BlockMesh_MetaData) };
	...
	template<> CPP_API UClass* StaticClass<ABlock>()
	{
		return ABlock::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ABlock);
	ABlock::~ABlock() {}
	struct Z_CompiledInDeferFile_FID_CPP_Source_CPP_Block_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CPP_Source_CPP_Block_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ABlock, ABlock::StaticClass, TEXT("ABlock"), &Z_Registration_Info_UClass_ABlock, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABlock), 3932716877U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CPP_Source_CPP_Block_h_3371313701(TEXT("/Script/CPP"),
		Z_CompiledInDeferFile_FID_CPP_Source_CPP_Block_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CPP_Source_CPP_Block_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
